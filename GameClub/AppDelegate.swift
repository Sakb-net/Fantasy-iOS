...
//        let leagueRankingViewController = LeagueRankingViewController(nibName: "LeagueRankingViewController", bundle: nil)
//        let appDelegate = UIApplication.shared.delegate as! AppDelegate
//        appDelegate.window?.rootViewController = leagueRankingViewController
