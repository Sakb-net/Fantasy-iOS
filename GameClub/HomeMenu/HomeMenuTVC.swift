...
class HomeMenuTVC: UITableViewController {
    ...
    var menuArabicTitles = ["الرئيسية","نقاطي","فريقي","اجراء انتقالات","قواعد اللعبة","أخبار","فيديو","إحصائيات","المباريات","الجوائز","المساعدة","اتصل بنا","English"]
    var menuEngTitles = ["Home","My Points","My Team","Transferes","Rules","News","Videos","Statistics","Fixtures","Awards","Help","Contact Us","العربية"]
